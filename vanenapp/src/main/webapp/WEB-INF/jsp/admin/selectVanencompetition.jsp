...
<stripes:layout-render name="/WEB-INF/jsp/templates/main.jsp">
    ...
    <stripes:layout-component name="body">
        ...
        <h1>Kies een vanencompetitie</h1><br/>
            ...
            <table>
                ...
                <c:forEach items="${actionBean.vanencompetitions}" var="v">
                    <tr>
                        ...
                        <td><a href='<stripes:url beanclass="com.roybraam.vanenapp.stripes.PointsActionBean" event="showPoints"/>?vanencompetition=${v.id}'>Selecteer</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
