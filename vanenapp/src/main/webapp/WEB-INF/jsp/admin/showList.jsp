...
<stripes:layout-render name="/WEB-INF/jsp/templates/main.jsp">
    ...
    <stripes:layout-component name="body">
        ...
        <div>
            ...
            <a href='<stripes:url beanclass="com.roybraam.vanenapp.stripes.ListActionBean" event="listParticipantsWithMemberNumber"/>'>Deelnemende Karateka's met KBN nummer</a><br/>
        </div>
        <div>
            <h2>Kata</h2>
